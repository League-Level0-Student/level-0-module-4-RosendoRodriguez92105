...
public class SleepyHead {
	...
	public static void main(String[] args) {
		...
		// If it is the weekend, tell the user they get to sleep in.
		        if (isWeekend) {JOptionPane.showMessageDialog(null, "Yay! you get to sleep in");}
        ...
        String score =JOptionPane.showInputDialog(null,"What percentage did you get on your test?");
		      int percentage=Integer.parseInt(score);
		      if (percentage>= 70) {
		     passedExam=true;
		      }
		      else {
